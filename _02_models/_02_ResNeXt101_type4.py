...
train_dir = "./train_type4"
test_dir = "./test_type4"
model_dir = "./models"
INPUT_SHAPE = (192, 65, 3)
...
if __name__ == '__main__':
    ...
    p_model = f"./models/{MODEL_NAME}_type4_{N_EPOCHS}epochs.h5"
    model.save(p_model)
    ...
    p_file = f"./result_img/{MODEL_NAME}_type4_{N_EPOCHS}epochs.png"
    fig.savefig(p_file)
    # plt.show()
