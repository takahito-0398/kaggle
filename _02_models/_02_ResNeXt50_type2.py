...
def setModel(input_shape):
    ...
    main_model = ResNeXt50(weights='imagenet',
    ...
    # main_model = ResNeXt50(include_top=False, weights='imagenet',input_tensor=input_tensor)
...
if __name__ == '__main__':
    ...
    for epoch in range(N_EPOCHS):
        ...
        for X_batch, Y_batch in get_batch(X_train, y_train, 64):
